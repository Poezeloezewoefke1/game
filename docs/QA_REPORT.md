...
### The crystal guard on Cinder and Hallow cannot be hit

**Reproducible, characterised, not fixed.** Both levels now play from the menu
to the ruins crystal - which took defects 75 to 79 - and then stall in the same
place. The guard standing over `crystal_ruins` takes 0 to 2 hits in 60 volleys
